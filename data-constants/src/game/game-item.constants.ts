export class GameItemConstants {
     ...
     * Statue gem item IDs.
     */
    static readonly AscensionStatues = [
        7001,
        7002,
        7003,
        7004,
     ...
     */
    static readonly BronzeEnhancementMaterials = [
        6503,  // Proof
        6516,  // Bone
        6512,  // Fang
        6505,  // Dust
     ...
     * in the Item List in-game menu.
     */
    static readonly SilverEnhancementMaterials = [
        6502,  // Seed
        6508,  // Lantern
        6515,  // Crystal
        6509,  // Jewel
     ...
     */
    static readonly GoldEnhancementMaterials = [
        6507,  // Claw
        6517,  // Heart
        6506,  // Scale
        6518,  // Root
    ...
    static readonly OtherEnhancementMaterials = [
        6999,  // Lore
        7999   // Grail
    ] as ReadonlyArray<number>;

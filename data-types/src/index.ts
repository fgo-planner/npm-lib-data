...
export * from './master/account/basic-master-account.type';
...
export * from './planner/basic-plan-group.type';
export * from './planner/basic-plan.type';
...
export * from './user/basic-user.type';
